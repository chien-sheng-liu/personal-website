    ...
    <div className="relative min-h-screen text-slate-800 overflow-hidden">
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-10 max-w-6xl">
        <div>
          ...
          <div className="mt-8"><Link href="/yue/articles" className="text-sky-500 hover:text-indigo-600 font-semibold">← 返到文章列表</Link></div>
        </div>
        <aside className="hidden lg:block sticky top-28 h-max bg-slate-100 border border-slate-200 rounded-xl p-4">
          <div className="text-sm font-semibold text-slate-900 mb-2">目錄</div>
